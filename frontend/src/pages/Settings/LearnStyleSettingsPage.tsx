...
function SettingSlider({ 
  ...
  return (
    <div style={{ marginBottom: '30px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr 120px', alignItems: 'center', gap: '12px' }}>
        <span style={{ fontSize: '14px', color: '#666', textAlign: 'right' }}>
          {startLabel}
        </span>
        <Slider defaultValue={[50]} max={100} step={1} />
        <span style={{ fontSize: '14px', color: '#666', textAlign: 'left' }}>
          {endLabel}
        </span>
      </div>
    </div>
...
export function Settings() { 
    return (
        <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <SettingSlider title="Explanation" startLabel="Simply explained" endLabel="Formally explained" />
            <SettingSlider title="Documents" startLabel="Follow Documents" endLabel="General Knowledge" />
            <RagUpload />
