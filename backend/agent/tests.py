...
class ToolsTests(TestCase):
    ...
    def test_search_deck_documents_returns_empty_on_no_results(self, mock_embed, mock_client):
...
class FlashcardBacksideViewTests(APITestCase):
    ...
    def test_requires_authentication(self):
        self.client.logout()
        response = self.client.post('/api/agent/flashcard/backside/', {
...
class RapidFlashcardViewTests(APITestCase):
    ...
    def test_rapid_generation(self, mock_llm):
        ...
        response = self.client.post('/api/agent/flashcard/backside/rapid/', {
            'front': 'What is AI?'
        })
