...
@swagger_auto_schema(
    ...
    responses={
            ...
            schema=openapi.Schema(
                ...
                properties={
                    "access": openapi.Schema(
                        ...
                        description="Access token (expires in 2 hours)",
                    ),
        ...
        401: openapi.Response(
            "Invalid credentials", schema=openapi.Schema(type=openapi.TYPE_OBJECT)
        ),
    },
    security=[],
            ...
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        "access": openapi.Schema(
                            type=openapi.TYPE_STRING,
                            description="New access token (expires in 2 hours)",
                        ),
                        "refresh": openapi.Schema(
                            type=openapi.TYPE_STRING,
                            description="New refresh token (expires in 1 day)",
                        ),
                    },
                ),
            ),
